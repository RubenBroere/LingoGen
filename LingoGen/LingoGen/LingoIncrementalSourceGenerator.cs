...
public class LingoIncrementalSourceGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterImplementationSourceOutput(keys, (ctx, s) =>
        {
            ctx.AddSource($"{s}.g.cs", "// <auto-generated/>");
        });
    ...
    private static void GenerateCode(SourceProductionContext ctx, LingoEntry lingoEntry)
    {
        var source = $$"""
                       // <auto-generated/>
                       ...
                       namespace {{Namespace}}
                       {
                           ...
                           {
                               public const string {{lingoEntry.Key}} = "";
                           }
                       }
                       """;

        ctx.AddSource($"Test.g.cs", source);
    }
